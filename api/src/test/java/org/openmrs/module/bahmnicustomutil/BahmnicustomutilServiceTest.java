...
import org.openmrs.module.bahmnicustomutil.api.impl.BahmnicustomutilServiceImpl;
import static org.mockito.Mockito.*;
import static org.hamcrest.Matchers.*;
import static org.junit.Assert.*;

/**
 * This is a unit test, which verifies logic in BahmnicustomutilService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class BahmnicustomutilServiceTest {
	
	@InjectMocks
	BahmnicustomutilServiceImpl basicModuleService;
